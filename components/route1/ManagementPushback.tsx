...
export function ManagementPushback() {
  ...
  const step4Missing = [
    !r1.risksFilled && { id: "r1-step4-risks", label: "fill in all three risk fields" },
    !r1.allClassified && { id: "r1-step4-classify", label: "classify all three risks as Purchasing- or Governance-level" },
    !r1.recommendation && { id: "r1-step4-recommend", label: "choose a recommendation" },
  ].filter(Boolean) as { id: string; label: string }[];

  return (
    <section id="r1-step5" className="space-y-3">
      ...
      {!r1.step4Complete && <MissingList items={step4Missing} lead="Step 4 still needs:" />}
